...
// sort - price, discountPercentage,rating,stock,minimumOrderQuantity
// search - title,description,category,tags,brand
// filter - price,discountPercentage,rating,stock,brand
const useGetAllProducts = () => {
    ...
    const false_ = false;
    const _data = data['products'].slice(0, 100);
    data['products'] = _data;
    return { false_, data }
